...
export let btnPausa = document.getElementById("btn-pausa") || (() => {
  ...
  btn.style = "position:fixed; top:15px; right:15px; z-index:100; padding:6px 12px; font-size:14px; background:#263238; color:#fff; border:2px solid #4dd0e1; border-radius:6px; cursor:pointer;";
...
export let btnCheatBoss = document.getElementById("btn-cheat-boss") || (() => {
  ...
  btn.style = "position:fixed; top:55px; right:15px; z-index:100; padding:6px 12px; font-size:14px; background:#b71c1c; color:#fff; border:2px solid #ff5252; border-radius:6px; cursor:pointer; display:none;";
  document.body.appendChild(btn);
  return btn;
})();
